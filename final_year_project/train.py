        ...
        for root, directory, filenames in os.walk(path):
            for filename in filenames:
                ...
                face_haar_cascade = cv2.CascadeClassifier(
                    r'C:\Users\Suhil\PycharmProjects\untitled1\haarcascade_frontalface_alt.xml')  # Load haar classifier
                face = face_haar_cascade.detectMultiScale(gray_img, scaleFactor=1.32,
